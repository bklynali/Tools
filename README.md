...
- [BKLYN Kernel Download](https://github.com/bklynali/Tools/releases/tag/v1.2.5-Kernel)


- [BKSettings APK Download](https://github.com/bklynali/Tools/releases/tag/v1.2.6-apk)
...
***ROOT NEEDED**
 ...
 - HotSpot will hide all traffic

 - USB/Ethernet/Bluetooth Tethering

 - TTL Change IPV4/IPV6
